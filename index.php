            ...
            <div class="col-6 m-auto pt-4">
                <form action="index.php" method="GET">
                    ...
                    <select class="form-select" aria-label="Default select example">
                        <option selected value="-1">Cerca per parcheggio</option>
                        <option value="1">Con Parcheggio</option>
                        <option value="2">Senza Parcheggio</option>
                    </select>

                    <div>
                        <label class="text-white p-2" for="parola">Cerca per voto:</label>
                        <input class="w-100 p-2 border border-0 rounded-3" name="voto" id="voto" type="number" placeholder="3">
                    </div>
